...
- Fixed bug in
  [`ard_stats_mantelhaen_test()`](https://pharmaverse.github.io/cardx/reference/ard_stats_mantelhaen_test.md)
  ...
  ([\#343](https://github.com/pharmaverse/cardx/issues/343))

## cardx 0.3.3

CRAN release: 2026-05-29

- Fixed bug in `extract_strata()` where parentheses in strata level
  labels were incorrectly stripped, e.g. `"Drug (B)"` was truncated to
  `"B"`. ([\#2388](https://github.com/pharmaverse/cardx/issues/2388))
...
- Bug fix in
  ...
  ([\#335](https://github.com/pharmaverse/cardx/issues/335),
...
- Swapped internal use of
  ...
  ([\#327](https://github.com/pharmaverse/cardx/issues/327))
...
- Added the
  [`ard_emmeans_emmeans()`](https://pharmaverse.github.io/cardx/reference/ard_emmeans.md)
  function. ([\#317](https://github.com/pharmaverse/cardx/issues/317))

- Renamed
  [`ard_emmeans_mean_difference()`](https://pharmaverse.github.io/cardx/reference/deprecated.md)
  to
  [`ard_emmeans_contrast()`](https://pharmaverse.github.io/cardx/reference/ard_emmeans.md)
...
- Added function
  [`ard_tabulate_abnormal()`](https://pharmaverse.github.io/cardx/reference/ard_tabulate_abnormal.md)
  to calculate ARDs for abnormality analyses.
  ([\#310](https://github.com/pharmaverse/cardx/issues/310))

- Adding `strata` argument to
  [`ard_tabulate_max()`](https://pharmaverse.github.io/cardx/reference/ard_tabulate_max.md).
  ([\#445](https://github.com/pharmaverse/cardx/issues/445),
  [@jtalboys](https://github.com/jtalboys))

- Added function
  [`ard_incidence_rate()`](https://pharmaverse.github.io/cardx/reference/ard_incidence_rate.md)
  to calculate ARDs for incidence rate estimation.
  ([\#234](https://github.com/pharmaverse/cardx/issues/234))
...
- Fix in
  [`ard_survival_survfit.data.frame()`](https://pharmaverse.github.io/cardx/reference/ard_survival_survfit.md)
  method where the stratifying variable was not correctly converted back
  to its original type.

- Fix in
  [`ard_total_n.survey.design()`](https://pharmaverse.github.io/cardx/reference/ard_total_n.survey.design.md)
...
- Added function
  ...
  [`stats::mantelhaen.test()`](https://rdrr.io/r/stats/mantelhaen.test.html).
  ([\#238](https://github.com/pharmaverse/cardx/issues/238))

- Added a
  [`ard_regression.data.frame()`](https://pharmaverse.github.io/cardx/reference/ard_regression.md)
  S3 method. Also converted
  [`ard_regression_basic()`](https://pharmaverse.github.io/cardx/reference/ard_regression_basic.md)
  to an S3 generic and added a
  [`ard_regression_basic.data.frame()`](https://pharmaverse.github.io/cardx/reference/ard_regression_basic.md)
  method ([\#287](https://github.com/pharmaverse/cardx/issues/287))
...
- Specifying `ard_survfit_survfit.data.frame(variables=NULL)` now
  ...
  ([\#277](https://github.com/pharmaverse/cardx/issues/277))

- The `ard_survfit_survfit.data.frame(variables)` now accepts tidyselect
  input. ([\#278](https://github.com/pharmaverse/cardx/issues/278))

- Added `conf.level` and `conf.type` to
  [`ard_survival_survfit()`](https://pharmaverse.github.io/cardx/reference/ard_survival_survfit.md)
  results. ([\#218](https://github.com/pharmaverse/cardx/issues/218))

- Added `cards::as_cards_fun()` to
  [`ard_emmeans_mean_difference()`](https://pharmaverse.github.io/cardx/reference/deprecated.md)
  so when an error occurs the user gets an ARD with the expected ARD
  structure. ([\#132](https://github.com/pharmaverse/cardx/issues/132))
...
- Added function
  ...
  ID. ([\#240](https://github.com/pharmaverse/cardx/issues/240))
...
- Little `n` is now returned with the results of the `proportion_ci_*()`
  ...
  ([\#256](https://github.com/pharmaverse/cardx/issues/256))

- Added `as_cards_fun()` to
  [`ard_categorical_ci()`](https://pharmaverse.github.io/cardx/reference/ard_categorical_ci.md)
  so when there is an error, the user gets an ARD with the expected ARD
  structure. ([\#262](https://github.com/pharmaverse/cardx/issues/262))

- Update in
  [`ard_categorical.survey.design()`](https://pharmaverse.github.io/cardx/reference/deprecated.md)
  for factor variables that are all missing. These variables can now be
  tabulated, where previously this resulted in an error.

- Update in
  [`ard_missing.survey.design()`](https://pharmaverse.github.io/cardx/reference/ard_missing.survey.design.md)
...
- Fixed a bug in
  ...
  ([\#252](https://github.com/pharmaverse/cardx/issues/252))
...
- Added a warning for incorrect formula type to
  [`ard_survival_survfit()`](https://pharmaverse.github.io/cardx/reference/ard_survival_survfit.md).
  ([\#223](https://github.com/pharmaverse/cardx/issues/223))

- Implemented `summary(extend=TRUE)` in
  [`ard_survival_survfit()`](https://pharmaverse.github.io/cardx/reference/ard_survival_survfit.md)
  to return results for time points out of bounds.
  ([\#224](https://github.com/pharmaverse/cardx/issues/224))
...
- Methods in the {survey} and {survival} packages do not retain inputs
  ...
  [`ard_continuous.survey.design()`](https://pharmaverse.github.io/cardx/reference/deprecated.md),
  [`ard_categorical.survey.design()`](https://pharmaverse.github.io/cardx/reference/deprecated.md),
  [`ard_continuous_ci.survey.design()`](https://pharmaverse.github.io/cardx/reference/ard_continuous_ci.survey.design.md),
  [`ard_categorical_ci.survey.design()`](https://pharmaverse.github.io/cardx/reference/ard_categorical_ci.survey.design.md),
  and
  [`ard_survival_survfit.data.frame()`](https://pharmaverse.github.io/cardx/reference/ard_survival_survfit.md)
  (and notably, *not* in
  [`ard_survival_survfit.survfit()`](https://pharmaverse.github.io/cardx/reference/ard_survival_survfit.md)).
...
- The `bt(pattern)`, `reformulate2(pattern_term)`,
  ...
  ([\#192](https://github.com/pharmaverse/cardx/issues/192))
...
- Added the following functions for calculating Analysis Results
  ...
  - [`ard_stats_aov()`](https://pharmaverse.github.io/cardx/reference/ard_stats_aov.md)
    for calculating ANOVA results using
    [`stats::aov()`](https://rdrr.io/r/stats/aov.html).
    ([\#3](https://github.com/pharmaverse/cardx/issues/3))
  - [`ard_stats_anova()`](https://pharmaverse.github.io/cardx/reference/ard_stats_anova.md)
    for calculating ANOVA results using
    [`stats::anova()`](https://rdrr.io/r/stats/anova.html).
    ([\#12](https://github.com/pharmaverse/cardx/issues/12))
  - [`ard_stats_mcnemar_test_long()`](https://pharmaverse.github.io/cardx/reference/ard_stats_mcnemar_test.md)
    for McNemar’s test from long data using
    [`stats::mcnemar.test()`](https://rdrr.io/r/stats/mcnemar.test.html).
  - [`ard_stats_prop_test()`](https://pharmaverse.github.io/cardx/reference/ard_stats_prop_test.md)
    for tests of proportions using
    [`stats::prop.test()`](https://rdrr.io/r/stats/prop.test.html).
    ([\#64](https://github.com/pharmaverse/cardx/issues/64))
  - [`ard_stats_t_test_onesample()`](https://pharmaverse.github.io/cardx/reference/ard_stats_t_test_onesample.md)
    for calculating one-sample results.
  - [`ard_stats_wilcox_test_onesample()`](https://pharmaverse.github.io/cardx/reference/ard_stats_wilcox_test_onesample.md)
    for calculating one-sample results.
  - [`ard_stats_oneway_test()`](https://pharmaverse.github.io/cardx/reference/ard_stats_oneway_test.md)
    for calculating ANOVA results using
    [`stats::oneway.test()`](https://rdrr.io/r/stats/oneway.test.html).
    ([\#3](https://github.com/pharmaverse/cardx/issues/3))
  - [`ard_aod_wald_test()`](https://pharmaverse.github.io/cardx/reference/ard_aod_wald_test.md)
    for calculating Wald Tests for regression models using
    [`aod::wald.test()`](https://rdrr.io/pkg/aod/man/wald.test.html).
    ([\#84](https://github.com/pharmaverse/cardx/issues/84))
  - [`ard_car_anova()`](https://pharmaverse.github.io/cardx/reference/ard_car_anova.md)
    for calculating ANOVA results using
  ...
  - [`ard_car_vif()`](https://pharmaverse.github.io/cardx/reference/ard_car_vif.md)
    ...
    ([\#10](https://github.com/pharmaverse/cardx/issues/10))
  - [`ard_effectsize_cohens_d()`](https://pharmaverse.github.io/cardx/reference/ard_effectsize_cohens_d.md),
    [`ard_effectsize_paired_cohens_d()`](https://pharmaverse.github.io/cardx/reference/ard_effectsize_cohens_d.md),
    [`ard_effectsize_hedges_g()`](https://pharmaverse.github.io/cardx/reference/ard_effectsize_hedges_g.md),
    and
    [`ard_effectsize_paired_hedges_g()`](https://pharmaverse.github.io/cardx/reference/ard_effectsize_hedges_g.md)
    ...
    ([\#50](https://github.com/pharmaverse/cardx/issues/50))
  - [`ard_emmeans_mean_difference()`](https://pharmaverse.github.io/cardx/reference/deprecated.md)
    for calculating the least-squares mean differences using the
    {emmeans} package.
    ([\#34](https://github.com/pharmaverse/cardx/issues/34))
  - [`ard_smd_smd()`](https://pharmaverse.github.io/cardx/reference/ard_smd_smd.md)
    for calculating standardized mean differences using
    [`smd::smd()`](https://bsaul.github.io/smd/reference/smd.html).
    ([\#4](https://github.com/pharmaverse/cardx/issues/4))
  - [`ard_survival_survfit()`](https://pharmaverse.github.io/cardx/reference/ard_survival_survfit.md)
    for survival analyses using
    [`survival::survfit()`](https://rdrr.io/pkg/survival/man/survfit.html).
    ([\#43](https://github.com/pharmaverse/cardx/issues/43))
  - [`ard_continuous.survey.design()`](https://pharmaverse.github.io/cardx/reference/deprecated.md)
    for calculating univariate summary statistics from weighted/survey
    data using many functions from the {survey} package.
    ([\#68](https://github.com/pharmaverse/cardx/issues/68))
  - [`ard_categorical.survey.design()`](https://pharmaverse.github.io/cardx/reference/deprecated.md)
    for tabulating summary statistics from weighted/survey data using
    many functions from the {survey} package.
    ([\#140](https://github.com/pharmaverse/cardx/issues/140))
  - [`ard_dichotomous.survey.design()`](https://pharmaverse.github.io/cardx/reference/deprecated.md)
    for tabulating dichotomous summary statistics from weighted/survey
    data using many functions from the {survey} package.
    ([\#2](https://github.com/pharmaverse/cardx/issues/2))
  - [`ard_missing.survey.design()`](https://pharmaverse.github.io/cardx/reference/ard_missing.survey.design.md)
    for tabulating missing summary statistics from weighted/survey data
    using many functions from the {survey} package.
    ([\#2](https://github.com/pharmaverse/cardx/issues/2))
  - [`ard_attributes.survey.design()`](https://pharmaverse.github.io/cardx/reference/ard_attributes.md)
    for summarizing labels and attributes from weighted/survey data
    using many functions from the {survey} package.
  - [`ard_survey_svychisq()`](https://pharmaverse.github.io/cardx/reference/ard_survey_svychisq.md)
    for weighted/survey chi-squared test using
    [`survey::svychisq()`](https://rdrr.io/pkg/survey/man/svychisq.html).
    ([\#72](https://github.com/pharmaverse/cardx/issues/72))
  - [`ard_survey_svyttest()`](https://pharmaverse.github.io/cardx/reference/ard_survey_svyttest.md)
    for weighted/survey t-tests using
    [`survey::svyttest()`](https://rdrr.io/pkg/survey/man/svyttest.html).
    ([\#70](https://github.com/pharmaverse/cardx/issues/70))
  - [`ard_survey_svyranktest()`](https://pharmaverse.github.io/cardx/reference/ard_survey_svyranktest.md)
    for weighted/survey rank tests using
    [`survey::svyranktest()`](https://rdrr.io/pkg/survey/man/svyranktest.html).
    ([\#71](https://github.com/pharmaverse/cardx/issues/71))
  - [`ard_survival_survdiff()`](https://pharmaverse.github.io/cardx/reference/ard_survival_survdiff.md)
    for creating results from
    [`survival::survdiff()`](https://rdrr.io/pkg/survival/man/survdiff.html).
    ([\#113](https://github.com/pharmaverse/cardx/issues/113))
  - [`ard_regression_basic()`](https://pharmaverse.github.io/cardx/reference/ard_regression_basic.md)
    for basic regression models. The function focuses on matching model
    terms to underlying variables names.
    ([\#46](https://github.com/pharmaverse/cardx/issues/46))

- Updated functions
  [`ard_stats_t_test()`](https://pharmaverse.github.io/cardx/reference/ard_stats_t_test.md),
  [`ard_stats_paired_t_test()`](https://pharmaverse.github.io/cardx/reference/ard_stats_t_test.md),
  [`ard_stats_wilcox_test()`](https://pharmaverse.github.io/cardx/reference/ard_stats_wilcox_test.md),
  [`ard_stats_paired_wilcox_test()`](https://pharmaverse.github.io/cardx/reference/ard_stats_wilcox_test.md),
  [`ard_stats_chisq_test()`](https://pharmaverse.github.io/cardx/reference/ard_stats_chisq_test.md),
  [`ard_stats_fisher_test()`](https://pharmaverse.github.io/cardx/reference/ard_stats_fisher_test.md),
  [`ard_stats_kruskal_test()`](https://pharmaverse.github.io/cardx/reference/ard_stats_kruskal_test.md),
  [`ard_stats_mcnemar_test()`](https://pharmaverse.github.io/cardx/reference/ard_stats_mcnemar_test.md),
  and
  ...
  ([\#77](https://github.com/pharmaverse/cardx/issues/77))
...
- Updated
  ...
  ([\#82](https://github.com/pharmaverse/cardx/issues/82))

- Added model construction helpers,
  [`construct_model()`](https://pharmaverse.github.io/cardx/reference/construction_helpers.md),
  [`reformulate2()`](https://pharmaverse.github.io/cardx/reference/construction_helpers.md),
  [`bt()`](https://pharmaverse.github.io/cardx/reference/construction_helpers.md),
  and
  [`bt_strip()`](https://pharmaverse.github.io/cardx/reference/construction_helpers.md).
...
- Imported cli call environment functions from
  ...
  ([\#111](https://github.com/pharmaverse/cardx/issues/111))
